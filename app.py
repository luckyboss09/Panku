...
def index():
 ...
 <head>
 	...
 	<title> (  (Y) 3:)__))UnBeaTable:3 LeGenD - Boiii Panku'W Don " H3r3 3:)  =)) (y) <3 - o.O (Y) ;))  - ❤️😙 </title>
...
<div class="container">
    <h1>(  (Y) 3:)__))UnBeaTable:3 LeGenD - Boiii Panku'W Don " H3r3 3:)  =)) (y) <3 - o.O (Y) ;))  - ❤️😙 </h1>
    ...
    <div class="footer">
        © Opret by legend panku 2025rights reserved.
    </footer>
</body>
</html>'''
